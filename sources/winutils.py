...
def resizeWindow(width,height):
  ...
  print win32gui.MoveWindow(fw,0,0,width,height,True)
...
def setProxy(config):
  os.system("C:/WebDiff/hudsuckr.exe (null) true true true true \""+config["host_machine"]+":8080\" \"<local>\" (null)")

def resetProxy():
  os.system("C:/WebDiff/hudsuckr.exe (null) true false false false \"(null)\" \"(null)\" (null)")
